...
/**
 * dup_chars - duplicates a sequence of characters from a string
 * @str: the input string
 * @start: the starting index of the sequence to duplicate
 * @stop: the stopping index of the sequence to duplicate
 *
